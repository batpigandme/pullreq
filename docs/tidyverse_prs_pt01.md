...
![dplyr summarise.html](https://i.imgur.com/O0YNHzH.png)
...
![summarise.R doesn't exist](https://i.imgur.com/SS5Pk7I.png)
...
tabs in your environement pane: **Build** and **Git**.
...
![Check icon in RStudio Build pane](https://i.imgur.com/nKdQIgw.png)

It's worth taking a look at the arguments, if only to help you undersand any 
