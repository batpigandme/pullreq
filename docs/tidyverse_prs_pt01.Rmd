...
Different parts of a pkgdown site come from different R-package components, some 
of which have already been rendered by the 
[`roxygen2`](https://github.com/klutometis/roxygen) package. 
