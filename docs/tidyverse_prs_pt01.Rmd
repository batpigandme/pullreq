...
will take you through the following workflow:
  ...
  * Fork `r icon::fa("code-branch")`
  * Clone `r icon::fa("clone")`
  * Check `r icon::fa("check-circle")`
  * Branch `r icon::fa("share-alt")`
  * Edit `r icon::fa("pencil-alt")`
...
output of R CMD check, everything is `r emo::ji("ok")`.
...
It's official, your pull request has been submitted. `r emo::ji("tada")`
