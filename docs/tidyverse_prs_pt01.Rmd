...
![Source: You Do Not Need to Tell Me I Have A Typo in My Documentation by Yihui Xie](`r here::here("docs", "imgs", "yihui_typos.png")`)  
...
![R Markdown README to Markdown README](`r here::here("docs", "imgs", "readme_rmd_to_md.png")`)
...
![dplyr summarise.html](`r here::here("docs", "imgs", "summarise_html_combo.png")`)
...
![summarise.R doesn't exist](`r here::here("docs", "imgs", "no_summarise_r_file.png")`)

But, since GitHub repos are searchable, we can just look for our text that way.[^2] 

![dplyr repo search for "backend that supports"](`r here::here("docs", "imgs", "repo_search_text.png")`)
...
!["...backend that supports" in `manip.R`](`r here::here("docs", "imgs", "manipr_top_bottom.png")`)
...
![Clone repo from your dplyr fork](`r here::here("docs", "imgs", "clone_repo.png")`)
...
![New project from Git in RStudio](`r here::here("docs", "imgs", "new_r_project_from_git.png")`)
...
![RStudio before and after cloning repo](`r here::here("docs", "imgs", "before_after_new_proj.png")`)
...
![Git branch icon](`r here::here("docs", "imgs", "local_git_branch.png")`)
...
![Check icon in RStudio Build pane](`r here::here("docs", "imgs", "build_check_button.png")`)
...
![dplyr R CMD check results](`r here::here("docs", "imgs", "dplyr_cmd_check.png")`)
 ...
 * Missing packages. 
    ...
    ![Missing suggested packages](`r here::here("docs", "imgs", "dplyr_cmd_check_old.png")`)
 ...
 * Assorted things totally unrelated to what I'm trying to fix
   ...
   ![Travis CI R CMD check](`r here::here("docs", "imgs", "travis_build_dplyr.png")`)
...
![Command history from checking, editing, and rebuilding dplyr documentation](`r here::here("docs", "imgs", "command_history.png")`)
...
![Run `devtools::check()`](`r here::here("docs", "imgs", "devtools_check.png")`)
...
![Check warnings on updated package](`r here::here("docs", "imgs", "R_CMD_check_success.png")`)
...
![RStudio Version Control Keyboard Shortcuts](`r here::here("docs", "imgs", "rstudio_git_shortcuts.png")`)
...
![Git diff and commit pane in RStudio](`r here::here("docs", "imgs", "rstudio_git_diff.png")`)
...
![Git commit from RStudio](`r here::here("docs", "imgs", "rstudio_git_commit.png")`)

And, finally, you'll be ready to `git push`.

![Git push from RStudio](`r here::here("docs", "imgs", "git_push.png")`)
...
![GitHub Compare](`r here::here("docs", "imgs", "github_compare_button.png")`)
...
![GitHub split-view diff](`r here::here("docs", "imgs", "github_splitview_diff.png")`)

You can get to a similar interface by clicking on **Compare & pull request**.

![GitHub Compare & pull request](`r here::here("docs", "imgs", "git_patch_ui.png")`)
...
![Selecting a base fork and a head fork when submitting a pull request on GitHub](`r here::here("docs", "imgs", "base_fork_head_fork_pr.png")`)

### Pull has been requested

It's official, your pull request has been submitted. `r emo::ji_glue(":tada:")`

![dplyr open pull requests](`r here::here("docs", "imgs", "dplyr_open_prs.png")`)
...
![Pull request icons indicating build status](`r here::here("docs", "imgs", "build_status.png")`)
...
![GitHub pull request build status](`r here::here("docs", "imgs", "pr_build_status.png")`)
