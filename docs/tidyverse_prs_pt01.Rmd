...
[^1]: True confession: I really didn't understand where those `do not edit by hand` files came from until I did an rOpenSci [package review](https://ropensci.org/blog/2017/08/22/first-package-review/) for Nick Tierney's `r emo::ji_glue(":star2:")` [`visdat`](http://visdat.njtierney.com/). Which, yes, is totally one of the great reasons to sign up to do one, too!
